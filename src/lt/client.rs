...
/// The client is cloned per worker (cheap Arc clone) so all workers
/// share the same connection pool.
pub fn create_http_client() -> Result<Client<HttpsConnector<HttpConnector>, Full<Bytes>>, anyhow::Error> {
